      ...
      <div className="container-custom">
        <header className="flex flex-col md:flex-row justify-between items-end gap-12 mb-20">
          ...
          <div className="flex items-center gap-6">
             ...
             <Button onClick={handleSortToggle} variant="secondary" className="rounded-full px-10 h-14 bg-slate-950 text-white min-w-[200px]">
                {getSortLabel()} <HiOutlineAdjustmentsHorizontal size={18} className="ml-3" />
             </Button>
          </div>
        </header>
                ...
                >
                  <div className={`relative overflow-hidden bg-slate-50 rounded-[3rem] shadow-premium transition-premium group-hover:shadow-emerald-200/50 ${viewMode === "grid" ? "aspect-[3/4] mb-8" : "w-64 h-80 flex-shrink-0"}`}>
                    ...
                    <div className="absolute inset-x-8 bottom-8 flex gap-3 translate-y-20 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-premium">
                       ...
                       <Link to={`/product/${product.id}`} className="w-14 h-14 bg-white text-slate-950 hover:bg-slate-200 rounded-2xl flex items-center justify-center shadow-xl transition-premium">
                    ...
                    {product.badge === "Lab Edition" && (
                      <div className="absolute top-8 left-8">
                         <span className="px-3 py-1 bg-slate-950 text-white text-[9px] font-black uppercase tracking-widest rounded-lg flex items-center gap-2 shadow-lg">
                           {product.badge}
                         </span>
                      </div>
                    )}
                    {product.badge === "Hot" && (
                      <div className="absolute top-8 left-8">
                         <span className="px-3 py-1 bg-slate-950 text-white text-[9px] font-black uppercase tracking-widest rounded-lg flex items-center gap-2">
